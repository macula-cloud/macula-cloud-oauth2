...
public class RefreshToken extends AbstractAuditable<Long> {
	...
	@Transient
	private OAuth2RefreshToken oauth2Token;
	...
	public OAuth2RefreshToken getOauth2Token() {
	...
	public void setOauth2Token(OAuth2RefreshToken oauth2Token) {
