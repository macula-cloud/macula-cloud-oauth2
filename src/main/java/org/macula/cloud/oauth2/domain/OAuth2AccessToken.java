...
public class OAuth2AccessToken extends AbstractAuditable<Long> implements Serializable {
	...
	@Transient
	private org.springframework.security.oauth2.common.OAuth2AccessToken oauth2Token;
	...
	public org.springframework.security.oauth2.common.OAuth2AccessToken getOauth2Token() {
	...
	public void setOauth2Token(org.springframework.security.oauth2.common.OAuth2AccessToken oauth2Token) {
